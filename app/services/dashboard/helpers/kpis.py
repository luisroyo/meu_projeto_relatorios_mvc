...
from app import db
from app.models import Ronda, EscalaMensal, User, Ocorrencia
...
def calculate_average_rondas_per_day(total_rondas: int, filters: dict, date_start_range, date_end_range) -> float:
    """
