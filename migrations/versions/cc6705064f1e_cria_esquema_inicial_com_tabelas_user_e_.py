"""Cria esquema inicial com tabelas User e LoginHistory

Revision ID: cc6705064f1e
Revises: 
Create Date: 2025-05-17 13:21:31.125355
...
def upgrade():
    ...
    sa.Column('attempted_username', sa.String(length=80), nullable=False),
