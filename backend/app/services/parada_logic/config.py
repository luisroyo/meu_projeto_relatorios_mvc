...
REGEX_PREFIXO_LINHA = re.compile(
    ...
    r"(\d{1,2}/\d{1,2}/\d{2,4})\s*"  # Grupo 2: Data do log (DD/MM/YYYY ou DD/MM/YY)
...
TIPO_PARADA_REGEX_PART = r"(?:parada|estacionado|ponto\s+fixo)"
...
PARADA_EVENT_REGEX_PATTERNS = [
    ...
    {"tipo": "inicio", "regex_str": rf"{TIME_CAPTURE_REGEX_PART}.*?{INICIO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}"},
    {"tipo": "termino", "regex_str": rf"{TIME_CAPTURE_REGEX_PART}.*?{TERMINO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}"},
    ...
    {"tipo": "inicio", "regex_str": rf"{INICIO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}.*?\s+{TIME_CAPTURE_REGEX_PART}"},
    {"tipo": "termino", "regex_str": rf"{TERMINO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}.*?\s+{TIME_CAPTURE_REGEX_PART}"},
    {"tipo": "inicio", "regex_str": rf"{INICIO_KEYWORDS_REGEX_PART}.*?\s+{TIME_CAPTURE_REGEX_PART}"},
    {"tipo": "termino", "regex_str": rf"{TERMINO_KEYWORDS_REGEX_PART}.*?\s+{TIME_CAPTURE_REGEX_PART}"},
    ...
    {"tipo": "inicio", "regex_str": rf"{SIMPLE_HOUR_CAPTURE_REGEX_PART}.*?{INICIO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}"},
    {"tipo": "termino", "regex_str": rf"{SIMPLE_HOUR_CAPTURE_REGEX_PART}.*?{TERMINO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}"},
    {"tipo": "inicio", "regex_str": rf"{INICIO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}.*?\s+{SIMPLE_HOUR_CAPTURE_REGEX_PART}"},
    {"tipo": "termino", "regex_str": rf"{TERMINO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}.*?\s+{SIMPLE_HOUR_CAPTURE_REGEX_PART}"},
    
    # Padrões que detectam apenas a palavra-chave (sem hora) para a lógica de bloco
    {"tipo": "inicio", "regex_str": rf"^\s*{INICIO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}\s*$", "keyword_only": True},
    {"tipo": "termino", "regex_str": rf"^\s*{TERMINO_KEYWORDS_REGEX_PART}{PREPOSICOES_ARTIGOS_REGEX_PART}{TIPO_PARADA_REGEX_PART}\s*$", "keyword_only": True},
